...
const translations = {
  en: {
    ...
    deliveryCopy:
      "From stores, offices, or friends - everything stays on the way.",
  ...
  ar: {
    ...
    deliveryCopy:
      "من المتاجر أو المكاتب أو الأصدقاء - كل شيء يبقى في الطريق بسهولة.",
    ...
    <div className="page landing-page">
      <div className="container">
        ...
        <main className="hero">
          <section className="hero-content fade-in delay-1">
            ...
            <div className="hero-stats">
              {stats.map((stat, index) => (
                <div
                  className={`stat fade-in delay-${index + 2}`}
                  key={stat.valueKey}
                >
          ...
          <section
            className="showcase fade-in delay-2"
        ...
        <section className="feature-strip" id="learn-more">
          {features.map((feature, index) => (
            <article
              className={`feature fade-in delay-${index + 2}`}
